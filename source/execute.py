...
for argument in dec2hex_arguments: #loop for input values
    ...
    res = subprocess.Popen([dec2hex_program, argument], stdin=subprocess.PIPE, stdout=subprocess.PIPE)
...
for argument in hex2dec_arguments:
    res = subprocess.Popen([hex2dec_program, argument], stdin=subprocess.PIPE, stdout=subprocess.PIPE)
